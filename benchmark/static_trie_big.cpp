...
BENCHMARK(BM_BigStaticTrieCreation)->RangeMultiplier(10)->Range(1, 1'000);
BENCHMARK(BM_BigStaticTrieConstexprCreation)->RangeMultiplier(10)->Range(1, 1'000);
BENCHMARK(BM_BigStaticTrieContains)->RangeMultiplier(10)->Range(1, 1'000);
BENCHMARK(BM_BigStaticTrieGet)->RangeMultiplier(10)->Range(1, 1'000);
BENCHMARK(BM_BigStaticTrieGetAll)->RangeMultiplier(10)->Range(1, 1'000);
